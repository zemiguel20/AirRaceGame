...
Multiple factors are taken into the Lift and Drag Equations, mathematical equations that can predict how much lift and drag force will be generated by a given body moving at a given speed.
[[7]] [[14]]
...
D = Cd * A * .5 * r * V^2  <br> [[14]]

"The drag equation states that drag D is equal to the drag coefficient Cd times the density r times half of the [relative velocity V][9] squared times the reference area A." 
[[14]]

The drag reference area used will be the wing area.
